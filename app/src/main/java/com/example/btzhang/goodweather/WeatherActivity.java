...
import com.example.btzhang.goodweather.gson.Forecast;
import com.example.btzhang.goodweather.gson.Weather;
import com.example.btzhang.goodweather.service.AutoUpdateService;
...
/**
 * Created by BTZHANG on 2018/1/20.
 */
...
//            requestWeather(weatherId);
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" +
                weatherId + "&key=8eb0429d0341489db392eaabac92a70e";
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        refreshLayout.setRefreshing(false);//下拉刷新
                    }
                });
            }
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (weather!=null&&"ok".equals(weather.status)) {
                            ...
                            showWeatherInfo(weather);//忘记写这一句
                        } else {
                            Toast.makeText(WeatherActivity.this,"获取天气信息失败",Toast.LENGTH_SHORT).show();
